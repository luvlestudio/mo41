window.onload = () => {
  ...
  btnShareKa.addEventListener("click", () => {
    Kakao.Share.sendDefault({
      objectType: "feed",
      content: {
        title: "민병성 ♥ 박수빈의 모바일 청첩장",
        description: "2025년 1월11일 토요일♡",
        imageUrl: "https://i.imgur.com/xsDsGWR.png",
        imageWidth: 1200,
        imageHeight: 630,
        link: {
          mobileWebUrl: "https:/41.luvle.co.kr",
          webUrl: "https://mo41.luvle.co.kr",
        },
      },
      buttons: [
        {
          title: "자세히 보기",
          link: {
            mobileWebUrl: "https://mo41.luvle.co.kr",
            webUrl: "https://mo41.luvle.co.kr",
          },
        },
      ],
